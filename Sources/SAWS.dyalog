...
⍝ === End of variables definition ===
  ...
  ∇ r←larg Call rarg;service;method;arg;ok;cmd;port;req;hdr;z;page;protocol;host;lchost;req2send;mask;tmp;ss;http;body;resp;soapaction;xmlns;cert;secure;ssl;length;t;m;certdir
    ...
    lchost←HTTPUtils.lc host
               ⍝ First try to figure out protocol
    :If 'http://'≡7↑lchost ⋄ protocol←'http://' ⋄ host←7↓host
    :ElseIf 'https://'≡8↑lchost ⋄ protocol←'https://' ⋄ host←8↓host
    ...
    :Repeat
      :If 0≠1⊃z←DRC.Wait cmd TIMEOUT              ⍝ Loop, collecting pieces of response
